...
export const Register = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://ec2-18-189-150-72.us-east-2.compute.amazonaws.com:10000/user/create/", {
        method: "POST",
        headers: {
  ...
  return (
    <>
      <div className='justify-center items-center flex min-h-screen text-center bg-h-14 bg-gradient-to-r from-purple-300 to-purple-900'>
        <form
        ...
        >
          ...
          {isInvalid && (
            <p className='text-red-500'>Invalid username or password, try a different username</p>
          )}
          <button
